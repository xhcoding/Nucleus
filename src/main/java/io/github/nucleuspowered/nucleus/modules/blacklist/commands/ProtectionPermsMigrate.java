...
@RegisterCommand(value = { "protectionperms", "pp" }, subcommandOf = DummyCommands.MigrateCommand.class)
public class ProtectionPermsMigrate extends AbstractCommand<CommandSource> {

    private final BlacklistMigrationHandler blacklistMigrationHandler;

    @Inject
    public ProtectionPermsMigrate(BlacklistMigrationHandler blacklistMigrationHandler) {
